...
- Graph snapshot: `outputs/unknotdb-rf-policy-v4-descending-v0.sqlite`
- Corpus representations: 2,989
- Representations mapped to current graph stopping keys: 2,987
- Representations with a bundled canonical knot name: 2,884
...
- Sidecar: `outputs/unknotdb-identification-v4-v0.sqlite` (2,482,176 bytes)
